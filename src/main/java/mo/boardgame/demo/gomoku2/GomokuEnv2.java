...
import common.Tuple;
import mo.boardgame.demo.gomoku2.gui.GomokuBoardPane2;
 ...
 */
public class GomokuEnv2 extends BaseBoardGameEnv {

    private final static Logger logger = LoggerFactory.getLogger(GomokuEnv2.class);
    ...
    private GomokuBoardPane2 boardPane;

    public GomokuEnv2(NDManager manager, Random random, boolean verbose) {
    ...
    public Model buildBaseModel() {
        ...
        GomokuPolicyBlock2 policyNet = new GomokuPolicyBlock2(manager.newSubManager(), random);
    ...
    private NDList buildObservation() {
        ...
        for (int i = 0; i < NUM_SQUARES; i++) {
            ...
            if (token == null) {
                ...
                if (getCurPlayerId() == token.getPlayerId()) {
                    curPositions[h][w] = 1;
                } else {
                    oppoPositions[h][w] = 1;
                }
        ...
        NDList result = new NDList(curPositionArr.
                concat(oppoPositionArr, 0).
                concat(lastMoveArr, 0).
                concat(colourArr, 0).
                concat(legalPositionArr, 0));
        return result;
    }
    ...
    public void setBoardPane(GomokuBoardPane2 boardPane) {
    ...
    static final class GomokuStep implements Step {
